    ...
    public partial class SerialNumber : Form
    {
        ...
        private void SP_GenerateSN(string wo, int top)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@format", (DateTime.Now.ToString("yy" + GetIso8601WeekOfYear(DateTime.Now))));
        ...
        private void DefaultPrinter()
        {
            ...
            {
                engine.Start();
                LabelFormatDocument format = engine.Documents.Open(@"\\mex-fss-001\labels$\Rocket\cp_label2.btw");


                format.PrintSetup.PrinterName = @"\\MEX-BAR-003\" + config.Printer;
