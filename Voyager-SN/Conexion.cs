...
namespace Voyager_SN
{
    internal class Conexion
    {
        ...
        Con1 = new SqlConnection(@"Data Source=MEX-SQL-001;Initial Catalog=vaygersndb;User ID=admin_sql;Password=DaBatase#40107;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        //Con1 = new SqlConnection(@"Data Source=192.168.1.4\SQLEXPRESS;Initial Catalog=vaygersndb;User ID=admin;Password=mbettaglo;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        //Con1 = new SqlConnection(@"Data Source=MEX-W10-9SANKBV\SQLEXPRESS;Initial Catalog=vaygersndb;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
